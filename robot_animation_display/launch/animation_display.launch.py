...
def generate_launch_description():
    ...
    browser_cmd = ExecuteProcess(
        cmd=['bash', '-c', 'sleep 2 && google-chrome --new-window "file://$(ros2 pkg prefix robot_animation_display)/share/robot_animation_display/web/character_display.html" --start-fullscreen --window-position=1920,0 --user-data-dir=/tmp/chrome_profile2'],
        name='browser',
        output='screen',
    )
