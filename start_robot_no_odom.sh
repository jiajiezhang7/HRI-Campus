...
# 此shell脚本为了禁用小车底盘发布odom->base_link的tf关系，主要体现在hunter_base_no_odom.launch.py的参数传递中
...
gnome-terminal --title="hunter_base" -x bash -c "ros2 launch hunter_base hunter_base_no_odom.launch.py; exec bash"
